...
namespace GulfCoastWorkforceSolutions
{
    ...
    public static class DependencyResolverConfig
    {
        ...
        private static void ConfigureDependencyResolverForMvcApplication(ContainerBuilder builder)
        {
            ...
            builder.RegisterControllers(typeof(GulfCoastWorkforceSolutionsApplication).Assembly);

            //Register repositories
            builder.RegisterAssemblyTypes(typeof(GulfCoastWorkforceSolutionsApplication).Assembly)
