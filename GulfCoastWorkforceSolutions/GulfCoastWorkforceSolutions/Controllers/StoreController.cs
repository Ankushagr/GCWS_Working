...
using GulfCoastWorkforceSolutions.Models.Store;
using GulfCoastWorkforceSolutions.Repositories;
using GulfCoastWorkforceSolutions.Services;

[assembly: RegisterPageRoute("GulfCoastWorkforceSolutionsMvc.StoreSection", typeof(StoreController))]
...
namespace GulfCoastWorkforceSolutions.Controllers
{
    public class StoreController : Controller
    {
        ...
        {
            const string bestsellerCodename = "GulfCoastWorkforceSolutionsMvc.Bestseller";
