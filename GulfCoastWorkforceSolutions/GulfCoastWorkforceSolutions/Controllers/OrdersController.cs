...
using GulfCoastWorkforceSolutions.Models.Orders;
...
namespace GulfCoastWorkforceSolutions.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(IOrderRepository orderRepository, IShoppingService shoppingService, ICurrencyInfoProvider currencyInfoProvider, IOrderStatusInfoProvider orderStatusInfoProvider,
