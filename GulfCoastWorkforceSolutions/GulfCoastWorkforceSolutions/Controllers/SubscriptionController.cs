...
using GulfCoastWorkforceSolutions.Models.Subscription;
...
namespace GulfCoastWorkforceSolutions.Web.Controllers
{
    public class SubscriptionController : Controller
    {
        ...
        public ActionResult ConfirmSubscription(ConfirmSubscriptionModel model)
        {
            ...
            {
                ModelState.AddModelError(String.Empty, ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.News.ConfirmSubscriptionInvalidLink"));
            ...
            {
                ModelState.AddModelError(String.Empty, ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.News.ConfirmSubscriptionInvalidDateTime"));
            ...
            switch (result)
            {
                case ApprovalResult.Success:
                    model.ConfirmationResult = ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.News.ConfirmSubscriptionSucceeded");
                    break;

                case ApprovalResult.AlreadyApproved:
                    model.ConfirmationResult = ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.News.ConfirmSubscriptionAlreadyConfirmed");
                    break;

                case ApprovalResult.TimeExceeded:
                    ModelState.AddModelError(String.Empty, ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.News.ConfirmSubscriptionTimeExceeded"));
                    break;
                ...
                default:
                    ModelState.AddModelError(String.Empty, ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.News.ConfirmSubscriptionFailed"));
        ...
        {
            string invalidUrlMessage = ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.News.InvalidUnsubscriptionLink");
                ...
                if (emailIsValid)
                {
                    try
                    {
                        ...
                        if (model.UnsubscribeFromAll)
                        {
                            ...
                            model.UnsubscriptionResult = ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.News.UnsubscribedAll");
                        }
                        else
                        {
                            ...
                            if (newsletter != null)
                            {
                                ...
                                model.UnsubscriptionResult = ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.News.Unsubscribed");
                            }
                            else
                            {
