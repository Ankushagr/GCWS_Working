...
using GulfCoastWorkforceSolutions.Models.Generator;
using GulfCoastWorkforceSolutions.Controllers;

[assembly: RegisterPageRoute("GulfCoastWorkforceSolutionsMvc.Generator", typeof(GeneratorController))]
...
namespace GulfCoastWorkforceSolutions.Controllers
{
    ...
    public class GeneratorController : Controller
    {
        ...
        private const string FORM_NAME = "GulfCoastWorkforceSolutionsMvcCoffeeSampleList";
        ...
        private static void EnsureTask(ISiteInfo site)
        {
            ...
            var task = new TaskInfo
            {
                ...
                TaskClass = "Samples.GulfCoastWorkforceSolutions.EnableDataProtectionSampleTask",
                TaskEnabled = true,
