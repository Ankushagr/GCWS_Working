...
[assembly: RegisterWidget(BannerWidgetController.IDENTIFIER, typeof(BannerWidgetController), "{$GulfCoastWorkforceSolutionsmvc.widget.banner.name$}", Description = "{$GulfCoastWorkforceSolutionsmvc.widget.banner.description$}", IconClass = "icon-ribbon")]
...
namespace GulfCoastWorkforceSolutions.Controllers.Widgets
{
    ...
    public class BannerWidgetController : WidgetController<BannerWidgetProperties>
    {
        ...
        /// Widget identifier.
        /// </summary>
        public const string IDENTIFIER = "GulfCoastWorkforceSolutions.HomePage.BannerWidget";
