...
[assembly: RegisterWidget(NewsWidgetController.IDENTIFIER, typeof(NewsWidgetController), "News List Widget", Description = "{$GulfCoastWorkforceSolutionsmvc.widget.news.description$}", IconClass = "icon-ribbon")]
namespace GulfCoastWorkforceSolutions.Controllers.Widgets
{
    ...
    public class NewsWidgetController : WidgetController<NewsWidgetProperties>
    {
        ...
        /// Widget identifier.
        /// </summary>
        public const string IDENTIFIER = "GulfCoastWorkforceSolutions.NewsWidget";
