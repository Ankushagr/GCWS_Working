...
[assembly: RegisterWidget(ArticlesWidgetController.IDENTIFIER, typeof(ArticlesWidgetController), "{$GulfCoastWorkforceSolutionsmvc.widget.articles.name$}", Description = "{$GulfCoastWorkforceSolutionsmvc.widget.articles.description$}", IconClass = "icon-l-list-article")]
...
namespace GulfCoastWorkforceSolutions.Controllers.Widgets
{
    ...
    public class ArticlesWidgetController : WidgetController<ArticlesWidgetProperties>
    {
        ...
        /// Widget identifier.
        /// </summary>
        public const string IDENTIFIER = "GulfCoastWorkforceSolutions.HomePage.ArticlesWidget";
