...
using GulfCoastWorkforceSolutions.Models.Privacy;

[assembly: RegisterPageRoute("GulfCoastWorkforceSolutionsMvc.Privacy", typeof(PrivacyController))]
    ...
    public class PrivacyController : Controller
    {
        ...
        private void ExecuteRevokeTrackingConsentTask(ISiteInfo site, ContactInfo contact)
        {
            ...
            var task = new TaskInfo
            {
                ...
                TaskClass = "Samples.GulfCoastWorkforceSolutions.RevokeTrackingConsentTask",
                TaskEnabled = true,
