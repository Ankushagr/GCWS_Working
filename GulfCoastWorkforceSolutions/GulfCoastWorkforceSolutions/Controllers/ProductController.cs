    ...
    public class ProductController : Controller
    {
        ...
        public JsonResult Variant(List<int> options, int parentProductID)
        {
            ...
            if (variant == null)
            {
                return Json(new
                {
                    stockMessage = ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.Product.NotAvailable"),
                    totalPrice = "-"
                });
            }
            ...
            return GetVariantResponse(variantPrice,
                                      isInStock,
                                      allowSale,
                                      isInStock ? "GulfCoastWorkforceSolutionsMvc.Product.InStock" : "GulfCoastWorkforceSolutionsMvc.Product.OutOfStock",
