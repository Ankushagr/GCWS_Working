...
namespace GulfCoastWorkforceSolutions.Controllers
{
    public class CheckoutController : Controller
    {
        ...
        public ActionResult PreviewAndPay(PreviewViewModel model)
        {
            ...
            if (cart.IsEmpty)
            {
                ModelState.AddModelError("cart.empty", ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.Checkout.EmptyCartError"));
            ...
            {
                ModelState.AddModelError("PaymentMethod.PaymentMethodID", ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.Payment.PaymentMethodRequired"));
            }
            else
            {
        ...
        public ActionResult DeliveryDetails(DeliveryDetailsViewModel model)
        {
            ...
            {
                ModelState.AddModelError("ShippingOption.ShippingOptionID", ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.Shipping.ShippingOptionRequired"));
            }
            ...
            if (!checkoutService.IsCountryValid(countryStateViewModel.CountryID))
            {
                ...
                ModelState.AddModelError("BillingAddress.BillingAddressCountryStateSelector.CountryID", ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.Address.CountryIsRequired"));
            }
            else if (!checkoutService.IsStateValid(countryStateViewModel.CountryID, countryStateViewModel.StateID))
            {
                ...
                ModelState.AddModelError("BillingAddress.BillingAddressCountryStateSelector.StateID", ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.Address.StateIsRequired"));
            }
