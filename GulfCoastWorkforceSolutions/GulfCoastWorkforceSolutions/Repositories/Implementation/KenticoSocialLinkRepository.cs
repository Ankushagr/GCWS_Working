...
namespace GulfCoastWorkforceSolutions.Repositories.Implementation
{
    ...
    public class KenticoSocialLinkRepository : ISocialLinkRepository
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KenticoSocialLinkRepository"/> class that returns links.
        /// </summary>
        /// <param name="pageRetriever">Retriever for pages based on given parameters.</param>
        public KenticoSocialLinkRepository(IPageRetriever pageRetriever)
        {
        ...
        public IEnumerable<SocialLink> GetSocialLinks()
        {
            return pageRetriever.Retrieve<SocialLink>(
                ...
                cache => cache
                    .Key($"{nameof(KenticoSocialLinkRepository)}|{nameof(GetSocialLinks)}")
