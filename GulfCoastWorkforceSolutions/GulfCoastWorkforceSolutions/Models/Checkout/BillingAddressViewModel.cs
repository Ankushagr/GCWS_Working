...
namespace GulfCoastWorkforceSolutions.Models.Checkout
{
    ...
    {
        [Required]
        [Display(Name = "GulfCoastWorkforceSolutionsMvc.Address.Line1")]
        [MaxLength(100, ErrorMessage = "GulfCoastWorkforceSolutionsMvc.General.MaximumInputLengthExceeded")]
        public string BillingAddressLine1 { get; set; }



        [Display(Name = "GulfCoastWorkforceSolutionsMvc.Address.Line2")]
        [MaxLength(100, ErrorMessage = "GulfCoastWorkforceSolutionsMvc.General.MaximumInputLengthExceeded")]
        public string BillingAddressLine2 { get; set; }


        [Required]
        [Display(Name = "GulfCoastWorkforceSolutionsMvc.Address.City")]
        [MaxLength(100, ErrorMessage = "GulfCoastWorkforceSolutionsMvc.General.MaximumInputLengthExceeded")]
        public string BillingAddressCity { get; set; }


        [Required]
        [Display(Name = "GulfCoastWorkforceSolutionsMvc.Address.Zip")]
        [MaxLength(20, ErrorMessage = "GulfCoastWorkforceSolutionsMvc.General.MaximumInputLengthExceeded")]
