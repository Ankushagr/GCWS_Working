...
namespace GulfCoastWorkforceSolutions.Models.InlineEditors
{
    ...
    public class ImageUploaderEditorViewModel : InlineEditorViewModel
    {
        ...
        public string GetDataUrl()
        {
            ...
            {
                return urlHelper.Kentico().AuthenticateUrlRaw(urlHelper.Action("Upload", "AttachmentImageUploader", new
                {
            ...
            {
                return urlHelper.Kentico().AuthenticateUrlRaw(urlHelper.Action("Upload", "MediaFileImageUploader", new
                {
