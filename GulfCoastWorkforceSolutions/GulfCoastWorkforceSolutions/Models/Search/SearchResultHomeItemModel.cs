...
namespace GulfCoastWorkforceSolutions.Models.Search
{
    ...
    {
        public SearchResultHomeItemModel(SearchResultItem resultItem, CMS.DocumentEngine.Types.GCWS.Home home, IHomeRepository homeRepository, IPageUrlRetriever pageUrlRetriever)
