...
namespace GulfCoastWorkforceSolutions.PageTemplatesFilters
{
    /// <summary>
    ...
    public class ArticlePageTemplatesFilter : IPageTemplateFilter
    {
        ...
        {
            if (context.PageType.Equals("GulfCoastWorkforceSolutionsMvc.Article", StringComparison.InvariantCultureIgnoreCase))
            {
        ...
        /// </summary>
        public IEnumerable<string> GetArticlePageTemplates() => new string[] { "GulfCoastWorkforceSolutions.Article", "GulfCoastWorkforceSolutions.ArticleWithSidebar" };
    }
}