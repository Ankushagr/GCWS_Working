...
namespace GulfCoastWorkforceSolutions.Helpers
{
    /// <summary>
    ...
    public static class AreaRestrictionHelper
    {
        ...
        {
            var allowedScopes = new[] { "Kentico.", "GulfCoastWorkforceSolutions.General.", "GulfCoastWorkforceSolutions.LandingPage." };
        ...
        {
            var deniedScopes = new[] { "GulfCoastWorkforceSolutions.LandingPage." };
