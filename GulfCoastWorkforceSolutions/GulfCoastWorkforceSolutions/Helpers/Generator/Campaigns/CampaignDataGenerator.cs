...
namespace GulfCoastWorkforceSolutions.Helpers.Generator
{
    /// <summary>
    ...
    internal class CampaignDataGenerator
    {
        ...
        /// </summary>
        private const string CAMPAIGN_CAFE_SAMPLE_PROMOTION_RUNNING = "GulfCoastWorkforceSolutionsMVC.CafeSamplePromotion";


        /// <summary>
        /// Code name of the finished 'Cafe sample promotion' campaign.
        /// </summary>
        private const string CAMPAIGN_CAFE_SAMPLE_PROMOTION_FINISHED = "GulfCoastWorkforceSolutionsMVC.CafeSamplePromotionTest";
        ...
        private const string COFFEE_SAMPLE_LIST_FORM_CODE_NAME = "GulfCoastWorkforceSolutionsMvcCoffeeSampleList";
        ...
        public void Generate()
        {
            CampaignInfo.Provider.Get()
                .WhereStartsWith("CampaignName", "GulfCoastWorkforceSolutionsMVC.")
                .OnSite(mSite.SiteID)
                .ToList()
