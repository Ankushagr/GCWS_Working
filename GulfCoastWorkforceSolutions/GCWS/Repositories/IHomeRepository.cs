...
namespace GCWS.Repositories
{
    ...
    public interface IHomeRepository : IRepository
    {
        ...
        Task<IEnumerable<Home>> GetHomeSectionsAsync(string nodeAliasPath, CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <param name="nodeAliasPath">The node alias path of the Home in the content tree.</param>
        IEnumerable<Home> GetHomeSections(string nodeAliasPath);
