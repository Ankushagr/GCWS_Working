...
namespace GulfCoastWorkforceSolutions.Models.Widgets
{
    ...
    public class BannerWidgetProperties : IWidgetProperties
    {
        ...
        /// </summary>
        [EditingComponent(UrlSelector.IDENTIFIER, Order = 0, Label = "{$GulfCoastWorkforceSolutionsMVC.Widget.Banner.LinkUrl$}")]
        [EditingComponentProperty(nameof(UrlSelectorProperties.Placeholder), "{$GulfCoastWorkforceSolutionsMVC.Widget.Banner.LinkUrl.Placeholder$}")]
        ...
        /// </remarks>
        [EditingComponent(TextInputComponent.IDENTIFIER, Order = 1, Label = "{$GulfCoastWorkforceSolutionsMVC.Widget.Banner.LinkTitle$}")]
