...
namespace GCWS.Models.Widgets
{
    public class CarouselWidgetProperties : IWidgetProperties
    {
        ...
        /// </summary>
        [EditingComponent(UrlSelector.IDENTIFIER, Order = 0, Label = "{GCWS.Widget.Carousel.LinkUrl$}")]
        [EditingComponentProperty(nameof(UrlSelectorProperties.Placeholder), "{GCWS.Widget.Carousel.LinkUrl.Placeholder$}")]
        ...
        /// </remarks>
        [EditingComponent(TextInputComponent.IDENTIFIER, Order = 1, Label = "{GCWS.Widget.Carousel.LinkTitle$}")]
