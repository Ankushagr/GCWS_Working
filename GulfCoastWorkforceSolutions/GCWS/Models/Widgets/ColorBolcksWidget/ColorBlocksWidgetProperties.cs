...
{
    public class ColorBlocksWidgetProperties : IWidgetProperties
    {
        ...
        /// </summary>
        [EditingComponent(UrlSelector.IDENTIFIER, Order = 0, Label = "{GCWS.Widget.ColorBlock.LinkUrl$}")]
        [EditingComponentProperty(nameof(UrlSelectorProperties.Placeholder), "{GCWS.Widget.ColorBlock.LinkUrl.Placeholder$}")]
        ...
        /// </remarks>
        [EditingComponent(TextInputComponent.IDENTIFIER, Order = 1, Label = "{GCWS.Widget.ColorBlock.LinkTitle$}")]
