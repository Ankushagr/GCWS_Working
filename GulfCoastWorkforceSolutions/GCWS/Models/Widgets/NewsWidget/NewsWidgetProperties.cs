...
namespace GCWS.Models.Widgets
{
    ...
    public class NewsWidgetProperties : IWidgetProperties
    {
        ...
        /// </summary>
        [EditingComponent(UrlSelector.IDENTIFIER, Order = 0, Label = "{GCWS.Widget.News.LinkUrl$}")]
        [EditingComponentProperty(nameof(UrlSelectorProperties.Placeholder), "{GCWS.Widget.News.LinkUrl.Placeholder$}")]
        ...
        /// </remarks>
        [EditingComponent(TextInputComponent.IDENTIFIER, Order = 1, Label = "{GCWS.Widget.News.LinkTitle$}")]
