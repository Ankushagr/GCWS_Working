...
[assembly: RegisterWidget(ImageWidgetController.IDENTIFIER, typeof(ImageWidgetController), "{$GulfCoastWorkforceSolutionsmvc.widget.image.name$}", Description = "{$GulfCoastWorkforceSolutionsmvc.widget.image.description$}", IconClass = "icon-picture")]
...
namespace GulfCoastWorkforceSolutions.Controllers.Widgets
{
    ...
    public class ImageWidgetController : WidgetController<ImageWidgetProperties>
    {
        ...
        /// Widget identifier.
        /// </summary>
        public const string IDENTIFIER = "GulfCoastWorkforceSolutions.HomePage.ImageWidget";
