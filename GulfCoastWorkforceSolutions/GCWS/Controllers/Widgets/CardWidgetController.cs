...
[assembly: RegisterWidget(CardWidgetController.IDENTIFIER, typeof(CardWidgetController), "{$GulfCoastWorkforceSolutionsmvc.widget.card.name$}", Description = "{$GulfCoastWorkforceSolutionsmvc.widget.card.description$}", IconClass = "icon-rectangle-paragraph")]
...
namespace GulfCoastWorkforceSolutions.Controllers.Widgets
{
    ...
    public class CardWidgetController : WidgetController<CardWidgetProperties>
    {
        ...
        /// Widget identifier.
        /// </summary>
        public const string IDENTIFIER = "GulfCoastWorkforceSolutions.LandingPage.CardWidget";
