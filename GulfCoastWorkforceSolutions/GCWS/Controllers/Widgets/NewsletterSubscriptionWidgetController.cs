...
[assembly: RegisterWidget(NewsletterSubscriptionWidgetController.IDENTIFIER, typeof(NewsletterSubscriptionWidgetController), "{$GulfCoastWorkforceSolutionsmvc.widget.newslettersubscription.name$}", Description = "{$GulfCoastWorkforceSolutionsmvc.widget.newslettersubscription.description$}", IconClass = "	icon-message")]
...
namespace GulfCoastWorkforceSolutions.Controllers.Widgets
{
    ...
    public class NewsletterSubscriptionWidgetController : WidgetController<NewsletterSubscriptionProperties>
    {
        ...
        /// Widget identifier.
        /// </summary>
        public const string IDENTIFIER = "GulfCoastWorkforceSolutions.NewsletterSubscriptionWidget";
        ...
        public ActionResult Subscribe(SubscribeModel model)
        {
            ...
            if (!subscriptionService.IsMarketable(contact, newsletter))
            {
                ...
                resultMessage = ResHelper.GetString(newsletter.NewsletterEnableOptIn ? "GulfCoastWorkforceSolutionsMvc.News.ConfirmationSent" : "GulfCoastWorkforceSolutionsMvc.News.Subscribed");
            }
            else
            {
                resultMessage = ResHelper.GetString("GulfCoastWorkforceSolutionsMvc.News.AlreadySubscribed");
            }
