...
namespace GCWS.PageTemplatesFilters
{
    /// <summary>
    /// Landing page template filter.
    /// </summary>
    /// <seealso cref="IPageTemplateFilter" />
    public class NewsPageTemplatesFilter : IPageTemplateFilter
    {
        /// <summary>
        ...
        {
            if (context.PageType.Equals("GCWS.News", StringComparison.InvariantCultureIgnoreCase))
            {
                return pageTemplates.Where(t => GetNewsPageTemplates().Contains(t.Identifier));
            }
        ...
        /// </summary>
        public IEnumerable<string> GetNewsPageTemplates() => new string[] { "GCWS.News" };
    }
}